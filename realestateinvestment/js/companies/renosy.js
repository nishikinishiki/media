...
window.companyData['renosy'] = {
    ...
    reasons: [
        ...
        { title: '充実の賃貸管理サービスで管理が楽ちん！', text: 'RENOSY※1では、忙しいオーナーに代わって入居者募集から家賃集金送金、クレーム対応※2まで、全面サポート。お客様の資産状況や、リスクに対する許容度に応じて多彩な管理プランをご用意しています。物件購入後は購入後もアプリやマイページでらくらく管理※3！所有物件の契約情報や入居状況、毎月の送金内容の確認はもちろん、困ったときの相談や毎年の確定申告も専用のアプリとマイページでサポート。はじめての不動産投資でも、カンタンに所有物件の管理ができます。' },
